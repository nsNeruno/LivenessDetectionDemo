 ...
 */
public class LivenessTestFragment extends Fragment implements Detector.DetectorInitCallback, LivenessCallback {
    /**
...
//    ProgressDialog mInitProgressDialog;
    ...
    public static LivenessTestFragment newInstance() {
        return new LivenessTestFragment();
    }

    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_liveness_test, container, false);
    }
...
//            mMaskImageView = activity.findViewById(R.id.mask_view);
            mLivenessView = activity.findViewById(R.id.liveness_test_view);
//            mTipImageView = activity.findViewById(R.id.tip_image_view);
            mTipTextView = activity.findViewById(R.id.tip_test_text_view);
...
//            anim.start();
    ...
    public void onDetectorInitStart() {
        Log.d("Liveness Event", "onDetectionInitStart");
...
//        }
    ...
    public void onDetectorInitComplete(final boolean isValid, final String errorCode,
        ...
        Log.d("Liveness Event", "onDetectorInitComplete");
//        if (mInitProgressDialog != null) {
//            mInitProgressDialog.dismiss();
//        }
        if (isValid) {
...
//    }
    ...
    public void onDetectionActionChanged() {
        Log.d("Liveness Event", "onDetectionActionChanged");
        playSound();
        showActionTipUIView();
//        mTimerView.setBackgroundResource(R.drawable.liveness_shape_right_timer);
    ...
    public void onDetectionSuccess() {
        Log.d("Liveness Event", "onDetectionSuccess");
...
//                mMaskImageView.setVisibility(View.GONE);
    ...
    public void onDetectionFrameStateChanged(Detector.WarnCode warnCode) {
        Log.d("Liveness Event", "onDetectionFrameStateChanged");
        if (isAdded()) {
    ...
    public void onActionRemainingTimeChanged(long remainingTimeMills) {
        Log.d("Liveness Event", "onActionRemainingTimeChanged: " + remainingTimeMills);
//        if (isAdded()) {
...
//        }
    ...
    public void onDetectionFailed(Detector.DetectionFailedType failedType, Detector.DetectionType detectionType) {
        Log.d("Liveness Event", "onDetectionFailed");
        if (isAdded()) {
            switch (failedType) {
                case WEAKLIGHT:
