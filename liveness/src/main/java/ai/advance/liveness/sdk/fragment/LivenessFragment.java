...
//            });
            ...
            guideCornerViews = new View[]{
                    activity.findViewById(R.id.guide_corner_1),
                    activity.findViewById(R.id.guide_corner_2),
                    activity.findViewById(R.id.guide_corner_3),
                    activity.findViewById(R.id.guide_corner_4),
                    activity.findViewById(R.id.guide_corner_5),
                    activity.findViewById(R.id.guide_corner_6),
                    activity.findViewById(R.id.guide_corner_7),
                    activity.findViewById(R.id.guide_corner_8)
            };
...
//        final String testStr = getResources().getString(strResId);
//        mTipTextView.setText(testStr + testStr);
...
//                mMaskImageView.setVisibility(View.GONE);
                for (int i = 0; i < guideCornerViews.length; i++) {
                    guideCornerViews[i].setVisibility(View.GONE);
                }
            }
